var myChart = echarts.init(document.getElementById('sxhot'));
function randomData() {
...
/*           
            ...
            tooltip: {
               ...
               formatter: function(datas) 
                {                
                  var res = '安装量:' +datas.value+ '台<br/>'+ '故障率:' + datas.data.lv;
                  return res;
                 }
            },
            ...
            series: [{
                ...
                animation: false,
            data:[
                {name: '太原市',value: 1000,lv:20},
                {name: '大同市', value: 4000,lv:130},
                {name: '阳泉市', value: 2000,lv:40},
                {name: '长治市', value: 3000,lv:32},
                {name: '朔州市', value: 1000,lv:31},
                {name: '晋中市', value: 10000,lv:50},
                {name: '运城市', value: 1000,lv:36},
                {name: '晋城市', value: 2500,lv:53},
                {name: '临汾市', value: 200,lv:30},
                {name: '吕梁市', value: 1000,lv:30},
                {name: '忻州市', value: 10000,lv:30}
            ]
